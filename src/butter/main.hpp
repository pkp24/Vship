...
float* getdiffmap(float* src1_d[3], float* src2_d[3], float* mem_d, int width, int height, float intensity_multiplier, int maxshared, GaussianHandle& gaussianHandle, hipStream_t stream){
    //Psycho Image planes
